...
if __name__ == "__main__":
    ...
    # NOVÁ KALIBRACE (Hledání dokonalého Hadronu)
    # Zvyšujeme sílu lepidla a posouváme bod, kdy sepne brzda.
    analyzer.run_proton_fusion(coupling_max=80.0, critical_pressure=5.5)
