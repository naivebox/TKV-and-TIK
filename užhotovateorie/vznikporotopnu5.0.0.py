...
# =====================================================================
# TKV PROJEKT 1836: GEOMETRICKÁ KLEC (ZLATÝ ŘEZ)
...
__kernel void tkv_dynamic_step(
    ...
    const double coupling_max) // Už nepotřebujeme umělý critical_pressure
{
...
class TKV_Analyzer_1836:
    def __init__(self, size=64):
        ...
        print(f"[+] Projekt 1836 (Geometrická Klec) online na: {dev.name}")
...
if __name__ == "__main__":
    ...
    # Nyní řídíme POUZE maximální sílu lepidla uprostřed.
    # O velikost bubliny se stará samotný Zlatý Řez!
    # Začneme na brutální hodnotě 250, a uvidíme, jestli to geometrie zastaví.
